...
<template>
  <div
    class="h-screen w-full overflow-hidden flex flex-col relative bg-white text-slate-900"
  >
    <!-- Mobile Header -->
    <header
    ...
    >
      ...
      <div class="flex items-center gap-2">
        <button
          @click="goHome"
          class="text-heigit-red bg-red-50 px-3 py-1.5 rounded-full border border-red-200"
          title="Back to Home"
        >
          <svg
        ...
        <button
          ...
          class="text-xs font-bold text-slate-500 bg-slate-50 px-3 py-1.5 rounded-full border border-slate-100"
        >
          About
        </button>
      </div>
    ...
    <main class="flex-1 relative overflow-hidden bg-slate-50">
      ...
      <div
        ...
        class="absolute top-4 left-4 right-4 flex flex-col gap-2 z-40"
      >
        <div
          class="bg-white/90 backdrop-blur-md border border-slate-200 rounded-xl shadow-lg p-3 flex flex-col gap-2"
        >
          ...
          <div v-if="disasters.length > 1" class="relative">
            ...
            <div
              ...
              class="absolute top-full left-0 mt-1 w-full bg-white border border-slate-200 rounded-lg shadow-lg z-50"
            >
              <div
                ...
                :class="{
                  'text-heigit-red font-bold bg-red-50': d === selectedDisaster,
              ...
              >
                ...
                <span
                  ...
                  class="text-heigit-red text-[10px]"
                  >●</span
                >
              </div>
            </div>
      ...
      <div
        v-if="viewMode === 'HOME'"
        class="absolute top-4 left-4 right-4 z-40 bg-slate-900/10 pointer-events-none"
      >
        <div
          class="w-full bg-white border border-slate-200 rounded-xl shadow-2xl p-4 pointer-events-auto flex flex-col gap-3"
        >
          <div class="text-center">
            ...
            <p class="text-[10px] text-slate-500 mt-0.5">
              Choose a country to analyze hazard risks
            </p>
          </div>
      ...
      <transition name="fade">
        <div
          v-if="isLoading"
          class="absolute inset-0 bg-white/80 backdrop-blur-md z-[60] flex items-center justify-center"
        >
          <div class="flex flex-col items-center gap-4">
            <div
              class="w-10 h-10 border-4 border-heigit-red border-t-transparent rounded-full animate-spin"
            ></div>
            <div
              class="text-[10px] text-slate-900 font-black tracking-widest uppercase"
            >
              Processing...
            </div>
          </div>
    ...
    <transition name="drawer">
      ...
      >
        ...
        <!-- Drawer Content -->
        <div
          class="relative bg-white rounded-t-[32px] shadow-2xl flex flex-col max-h-[85vh] transition-transform duration-500"
        >
          <!-- Handle -->
          <div
          ...
          <div class="flex-1 overflow-y-auto px-6 pb-12 custom-scrollbar">
            <header class="mb-6">
              ...
              <div class="flex items-center gap-2 mt-1">
                <span
                  class="px-2 py-0.5 rounded bg-red-50 text-[10px] font-black text-heigit-red uppercase"
                >
                  {{
                    selectedDisaster
            ...
            <div
              class="border border-slate-100 rounded-2xl overflow-hidden shadow-inner bg-slate-50"
            >
              <RiskStatistics
